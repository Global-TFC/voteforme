...
export function BallotUnit({ slug }: BallotUnitProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-800 via-zinc-700 to-zinc-900 flex items-center justify-center p-0 sm:p-4 md:p-6 lg:p-8">
      {/* EVM Machine Frame - Only visible on larger screens */}
      <div className="w-full max-w-md relative">
        {/* Machine Bezel/Frame */}
        <div className="hidden sm:block absolute -inset-4 md:-inset-6 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-3xl shadow-2xl">
          {/* Machine screws/rivets */}
          <div className="absolute top-3 left-3 w-3 h-3 bg-zinc-700 rounded-full shadow-inner"></div>
          <div className="absolute top-3 right-3 w-3 h-3 bg-zinc-700 rounded-full shadow-inner"></div>
          <div className="absolute bottom-3 left-3 w-3 h-3 bg-zinc-700 rounded-full shadow-inner"></div>
          <div className="absolute bottom-3 right-3 w-3 h-3 bg-zinc-700 rounded-full shadow-inner"></div>

          {/* EVM Label */}
          <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-yellow-400 px-4 py-1 rounded text-xs font-bold text-zinc-900 shadow-lg">
            EVM BALLOT UNIT
          </div>
        </div>

        {/* Ballot Unit Container */}
        <div className="relative bg-zinc-300/60 text-zinc-900 sm:rounded-2xl overflow-hidden shadow-2xl min-h-screen sm:min-h-0">
          <div className="relative mx-auto flex h-full w-full flex-col gap-3 bg-zinc-100">
