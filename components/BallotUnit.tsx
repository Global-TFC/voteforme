  ...
  return (
    <div className="min-h-screen bg-zinc-300/60  text-zinc-900">
      <div className="relative mx-auto flex h-full w-full max-w-sm flex-col gap-3 bg-zinc-100">
        ...
        <div className="flex-1 bg-zinc-200/80 px-2 py-2 pb-16 shadow-inner">
        ...
        {/* Sticky Share Button */}
        <div className="fixed bottom-0 left-0 right-0 z-10 flex justify-center bg-gradient-to-t from-zinc-200 via-zinc-200/95 to-transparent pb-4 pt-6">
          <button
            type="button"
